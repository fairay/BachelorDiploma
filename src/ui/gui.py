...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        spacerItem1 = QtWidgets.QSpacerItem(15, 13, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        ...
        self.calcRoutesW = QtWidgets.QPushButton(self.centralwidget)
        self.calcRoutesW.setMinimumSize(QtCore.QSize(300, 0))
        self.calcRoutesW.setMaximumSize(QtCore.QSize(300, 16777215))
        self.calcRoutesW.setObjectName("calcRoutesW")
        self.verticalLayout.addWidget(self.calcRoutesW)
        self.routeList = QtWidgets.QListWidget(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.routeList.sizePolicy().hasHeightForWidth())
        self.routeList.setSizePolicy(sizePolicy)
        self.routeList.setMinimumSize(QtCore.QSize(300, 0))
        self.routeList.setObjectName("routeList")
        self.verticalLayout.addWidget(self.routeList)
        ...
        self.config_action = QtWidgets.QMenu(self.menubar)
        ...
        self.action_stat = QtWidgets.QAction(MainWindow)
        self.action_stat.setObjectName("action_stat")
        self.action_schedule = QtWidgets.QAction(MainWindow)
        ...
        self.config_action.addAction(self.action_config)
        self.config_action.addAction(self.action_stat)
        self.config_action.addAction(self.action_schedule)
        self.menubar.addAction(self.menu_4.menuAction())
        self.menubar.addAction(self.menu_5.menuAction())
        self.menubar.addAction(self.config_action.menuAction())
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.config_action.setTitle(_translate("MainWindow", "Настройки"))
        ...
        self.action_config.setText(_translate("MainWindow", "Параметры"))
        self.action_stat.setText(_translate("MainWindow", "Статистика"))
        self.action_schedule.setText(_translate("MainWindow", "График маршрутов"))
